...
/**************vente bitume************************/
 ...
 FROM previsions  
 WHERE previsions.mois LIKE'%$mois%' AND previsions.centre=3060 AND   previsions.parametre=1 AND previsions.anne='$ann' ";
...
$reqt2="SELECT SUM(realisation) AS reali1
 FROM realisation  
 WHERE realisation.mois LIKE'%$mois%' AND realisation.centre=3060 AND   realisation.parametre=1 AND realisation.anne='$ann' ";
...
$reqt9="SELECT SUM(previsions) AS prev2
 FROM previsions 
 WHERE previsions.mois LIKE'%$mois%' AND previsions.centre=3060 AND  previsions.parametre=2 AND previsions.anne='$ann' ";
$resultp1 = mysqli_query($conn,$reqt9);
$parametres2 =$resultp1->fetch_assoc();

$reqt2="SELECT SUM(realisation) AS reali2
 FROM realisation  
 WHERE realisation.mois LIKE'%$mois%' AND realisation.centre=3060 AND   realisation.parametre=2 AND realisation.anne='$ann'";
...
$reqt3="SELECT SUM(previsions) AS prev3
 FROM previsions  
 WHERE previsions.mois LIKE'%$mois%' AND previsions.centre=3060 AND   previsions.parametre=4 AND previsions.anne='$ann' ";
$resulttp1 = mysqli_query($conn,$reqt3);
$parametres3 =$resulttp1->fetch_assoc();

$reqt4="SELECT SUM(realisation) AS reali3
 FROM realisation  
 WHERE realisation.mois LIKE'%$mois%' AND realisation.centre=3060 AND   realisation.parametre=4 AND realisation.anne='$ann'";
...
$reqt5="SELECT SUM(previsions) AS prev4
 FROM previsions  
 WHERE previsions.mois LIKE'%$mois%' AND previsions.centre=3060 AND   previsions.parametre=3 AND previsions.anne='$ann' ";
$resultim1 = mysqli_query($conn,$reqt5);
$parametres4 =$resultim1->fetch_assoc();

$reqt6="SELECT SUM(realisation) AS reali4
 FROM realisation  
 WHERE realisation.mois LIKE'%$mois%' AND realisation.centre=3060 AND   realisation.parametre=3 AND realisation.anne='$ann'";
